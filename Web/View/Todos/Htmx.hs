    ...
    html HtmxView { .. } = [hsx|
        <div class="header mb-3">
          ...
          <div class="d-flex gap-2 flex-wrap mt-3">
            ...
            <a class="btn btn-outline-primary btn-sm" href={pathTo TodosPlaygroundAction}>Open Navigation Playground</a>
        ...
        <div class="card p-3 mb-3">
          ...
          <ol class="mb-0">
            <li>Click <code>Open Navigation Playground</code> and back. URL and content should change via HTMX (no full page reload).</li>
            <li>Submit the filter form. URL should include <code>?q=...</code> (boosted GET navigation).</li>
            <li>Create a todo. Response is <code>204</code>, then the list updates via auto refresh.</li>
            <li>Use <code>Toggle</code> and <code>Delete</code> on list items. Mutations are applied, then the fragment updates automatically.</li>
          </ol>
        </div>
        ...
        <div class="card p-3 mb-3">
          ...
          <form method="GET" action={pathTo TodosHtmxAction} hx-push-url="true" class="row g-2 align-items-end">
            <div class="col-sm-8 col-md-6">
              ...
              <input id="todo-filter-query" name="q" class="form-control" placeholder="milk" value={searchQuery} />
            </div>
            <div class="col-sm-auto">
              <button class="btn btn-outline-primary" type="submit">Apply Filter</button>
            </div>
            <div class="col-sm-auto">
              <a class="btn btn-outline-secondary" href={pathTo TodosHtmxAction}>Clear</a>
            </div>
          </form>
        </div>
